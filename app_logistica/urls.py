...
urlpatterns = [
    ...
    path('buscar-proveedor-movimiento',views.buscar_proveedor_movimiento,name='buscar_proveedor_movimiento'),
    path('buscar-item-movimiento',views.buscar_item_movimiento,name='buscar_item_movimiento'),
    path('agregar-proveedor-stock',views.agregar_proveedor_stock,name='agregar_proveedor_stock'),
    path('agregar-proveedor-serializable',views.agregar_proveedor_serializable,name='agregar_proveedor_serializable'),        
    path('seleccionar-item-mov/<int:pk>',views.seleccionar_item_mov,name='seleccionar_item_mov'),    
    path('seleccionar-proveedor-mov/<int:pk>',views.seleccionar_proveedor_mov,name='seleccionar_proveedor_mov'),    
    path('editar-item-stock/<int:pk>/',views.editar_item_stock,name='editar_item_stock'),
    path('editar-item-serializable/<int:pk>/',views.editar_item_serializable,name='editar_item_serializable'),
    path('informacion-articulo-stock/<int:pk>',views.informacion_articulo_stock,name='informacion_articulo_stock'),
    path('informacion-articulo-serializable/<int:pk>',views.informacion_articulo_serializable,name='informacion_articulo_serializable'),
    path('informacion-articulo-serializable-celular/<int:pk>',views.informacion_articulo_serializable_celular,name='informacion_articulo_serializable_celular'),
    ...
    path('items-por-almacen/<int:pk>/',views.items_por_almacen,name='items_por_almacen'),
